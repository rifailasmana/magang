		...
		<div class="top_menu row m0">
			<div class="container-fluid">
				<div class="float-left">
					<p>Check Out My Instagram : <a href="https://instagram.com/hancingikam">Ignatius Victor</a></p>
				</div>
			...
			<nav class="navbar navbar-expand-lg navbar-light">
				<div class="container-fluid">
                    ...
                    <a class="navbar-brand logo_h" href="{{ url('/') }}">
						<img src="https://goodbuy.id/wp-content/uploads/2021/09/logogb.png" alt="">
					</a>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-2 col-md-6 col-sm-6">
					<div class="single-footer-widget f_social_wd">
						...
						<div class="f_social">
							<a href="https://instagram.com/hancingikam">
			...
			<div class="row footer-bottom d-flex justify-content-between align-items-center">
				<p class="col-lg-12 footer-text text-center">
                    ...
                    <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://instagram.com/hancingikam" target="_blank">Ignatius Victor</a>
				</p>
			</div>
		</div>
	</footer>
